...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Error Page | 403 | No Permission | </title>
    ...
    <body class="authentication-bg authentication-bg-pattern">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4">
                        ...
                        <div class="text-center">
                            <h3 class="mt-4">No Permission</h3>
        ...
        <footer class="footer footer-alt">
            2015 - <script>document.write(new Date().getFullYear())</script> &copy; SP-PRIME by <a href="" class="text-white-50">Coderthemes</a> 
        </footer>
